...
class Samsung extends ConnectorAdapterNAtoEUR{
    Samsung(EURSocket adaptee) {
        super(adaptee);
        System.out.println("Samsung adapter");
    }
}
class Apple extends ConnectorAdapterNAtoEUR{
    Apple(EURSocket adaptee) {
        super(adaptee);
        System.out.println("Apple adapter");
    }
...
public class AdapterPatternObject {
    public static void main(String[] args) {
        ...
        NASocket socket = new Samsung(new EURSocket());
